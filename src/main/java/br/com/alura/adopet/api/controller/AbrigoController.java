...
public class AbrigoController {
    ...
    public ResponseEntity<List<DadosDetalhadosPetDto>> listarPets(@PathVariable String idOuNome) {
        try {
            List<DadosDetalhadosPetDto> petsDoAbrigo = abrigoService.listarPetsDoAbrigo(idOuNome);
